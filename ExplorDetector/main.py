...
if __name__ == '__main__':
    ...
    for p in project_list:
        ...
        try:
            # zyx
            # cmd1 = "adb shell monkey -p com.example.accessibilityserver  -c android.intent.category.LAUNCHER 1"
            # out1 = os.system(cmd1)
            ...
            with open(os.path.join(p.res_dir, "time.txt"), "w") as f:
                f.write("consume_time: "+ str(consume_time) + "s")
